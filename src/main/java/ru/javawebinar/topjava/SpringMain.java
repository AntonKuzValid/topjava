...
//            adminUserController.getAllWithFilter().forEach(System.out::println);
...
//            mealRestController.getAllWithFilter().forEach(System.out::println);
...
//            mealRestController.getAllWithFilter().forEach(System.out::println);
//
//            mealRestController.getAllWithFilter(LocalDate.of(2015, Month.MAY, 30),LocalDate.of(2015, Month.MAY, 30)).forEach(System.out::println);
//
//            mealRestController.getAllWithFilter(LocalTime.of(10, 0),LocalTime.of(13, 0)).forEach(System.out::println);
//
//            mealRestController.getAllWithFilter(LocalDate.of(2015, Month.MAY, 30),LocalDate.of(2015, Month.MAY, 30),
//                    LocalTime.of(10, 0),LocalTime.of(13, 0)).forEach(System.out::println);
//            mealRestController.getAllWithFilter().forEach(System.out::println);
//            mealRestController.update(new Meal(LocalDateTime.now(),"new meal", 1000),100);
//            mealRestController.getAllWithFilter().forEach(System.out::println);
//            mealRestController.create(new Meal(LocalDateTime.now(),"new meal-1", 2000));
//            mealRestController.getAllWithFilter().forEach(System.out::println);
        }
    }
}
